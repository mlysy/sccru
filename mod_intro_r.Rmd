...
[Histograms](https://en.wikipedia.org/wiki/Histogram) are commonly used to visualize the distributions of continuous variables. When looking at histograms, pay attention to
...
The `r cran_link("ggplot2")` library is a package created by Hadley Wickham. It offers a powerful language to create elegant graphs. A basic introduction of this package can be found in the next [section][Introduction to ggplot2].
